...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxmultilang', 'widget/address/billing_address.tpl', 1, false),array('modifier', 'oxmultilangsal', 'widget/address/billing_address.tpl', 5, false),)), $this); ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxusername->value): ?><?php echo smarty_function_oxmultilang(array('ident' => 'EMAIL','suffix' => 'COLON'), $this);?>
...
<br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxustid->value): ?> <?php echo smarty_function_oxmultilang(array('ident' => 'VAT_ID_NUMBER','suffix' => 'COLON'), $this);?>
...
<br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxstateid->value): ?><?php echo $this->_tpl_vars['oxcmp_user']->getStateTitle(); ?>
 <?php endif; ?>
...
<br><br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxfon->value): ?> <?php echo smarty_function_oxmultilang(array('ident' => 'PHONE','suffix' => 'COLON'), $this);?>
 <?php echo $this->_tpl_vars['oxcmp_user']->oxuser__oxfon->value; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxfax->value): ?> <?php echo smarty_function_oxmultilang(array('ident' => 'FAX','suffix' => 'COLON'), $this);?>
 <?php echo $this->_tpl_vars['oxcmp_user']->oxuser__oxfax->value; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxmobfon->value): ?> <?php echo smarty_function_oxmultilang(array('ident' => 'CELLUAR_PHONE','suffix' => 'COLON'), $this);?>
 <?php echo $this->_tpl_vars['oxcmp_user']->oxuser__oxmobfon->value; ?>
<br><?php endif; ?>
<?php if ($this->_tpl_vars['oxcmp_user']->oxuser__oxprivfon->value): ?> <?php echo smarty_function_oxmultilang(array('ident' => 'PERSONAL_PHONE','suffix' => 'COLON'), $this);?>
 <?php echo $this->_tpl_vars['oxcmp_user']->oxuser__oxprivfon->value; ?>
<br><?php endif; ?>