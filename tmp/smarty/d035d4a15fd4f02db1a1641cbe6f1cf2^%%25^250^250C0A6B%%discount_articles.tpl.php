<?php /* Smarty version 2.6.28, created on 2016-03-16 21:54:04
         compiled from popups/discount_articles.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'popups/discount_articles.tpl', 1, false),array('modifier', 'cat', 'popups/discount_articles.tpl', 11, false),array('modifier', 'oxupper', 'popups/discount_articles.tpl', 11, false),array('function', 'oxmultilang', 'popups/discount_articles.tpl', 11, false),)), $this); ?>
...
cmpid=container1&container=discount_articles&synchoxid=<?php echo $this->_tpl_vars['oxid']; ?>
'
                                                    );
...
<?php echo '{ key:\'_'; ?><?php echo $this->_tpl_vars['iKey']; ?><?php echo '\', ident: '; ?><?php if ($this->_tpl_vars['aItem']['4']): ?><?php echo 'true'; ?><?php else: ?><?php echo 'false'; ?><?php endif; ?><?php echo ''; ?><?php if (! $this->_tpl_vars['aItem']['4']): ?><?php echo ',label: \''; ?><?php echo smarty_function_oxmultilang(array('ident' => ((is_array($_tmp=((is_array($_tmp='GENERAL_AJAX_SORT_')) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['aItem']['0']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['aItem']['0'])))) ? $this->_run_mod_handler('oxupper', true, $_tmp) : smarty_modifier_oxupper($_tmp))), $this);?><?php echo '\',visible: '; ?><?php if ($this->_tpl_vars['aItem']['2']): ?><?php echo 'true'; ?><?php else: ?><?php echo 'false'; ?><?php endif; ?><?php echo ',formatter: YAHOO.oxid.aoc.custFormatter'; ?><?php endif; ?><?php echo '}'; ?>
                                                      ...
                                                      <?php endforeach; endif; unset($_from); ?> ],
                                                    '<?php echo $this->_tpl_vars['oViewConf']->getAjaxLink(); ?>
cmpid=container2&container=discount_articles&oxid=<?php echo $this->_tpl_vars['oxid']; ?>
'
                                                    );
...
<br /><br /></td>
        ...
        <tr class="edittext">
            <td align="center"><b><?php echo smarty_function_oxmultilang(array('ident' => 'DISCOUNT_ARTICLES_ALLATRICLES'), $this);?>
</b></td>
            <td align="center"><b><?php echo smarty_function_oxmultilang(array('ident' => 'DISCOUNT_ARTICLES_SETARTICLES'), $this);?>
</b></td>
        </tr>
        <tr>
