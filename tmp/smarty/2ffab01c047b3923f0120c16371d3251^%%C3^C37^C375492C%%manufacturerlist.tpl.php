...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'count', 'widget/footer/manufacturerlist.tpl', 3, false),array('function', 'oxmultilang', 'widget/footer/manufacturerlist.tpl', 6, false),)), $this); ?>
...
<?php if (((is_array($_tmp=$this->_tpl_vars['manufacturers'])) ? $this->_run_mod_handler('count', true, $_tmp) : count($_tmp))): ?>
    ...
    <dl id="footerManufacturers">
        <dt><?php echo smarty_function_oxmultilang(array('ident' => 'MANUFACTURERS'), $this);?>
</dt>
        <dd>
        <ul class="list">
