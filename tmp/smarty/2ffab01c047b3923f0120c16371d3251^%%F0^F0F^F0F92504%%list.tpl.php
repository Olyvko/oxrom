...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxscript', 'page/list/list.tpl', 1, false),array('function', 'oxmultilang', 'page/list/list.tpl', 15, false),array('function', 'oxeval', 'page/list/list.tpl', 39, false),array('modifier', 'count', 'page/list/list.tpl', 120, false),)), $this); ?>
...
" class="categoryPicture">
        ...
        <?php if ($this->_tpl_vars['listType'] != 'tag' && $this->_tpl_vars['actCategory'] && $this->_tpl_vars['actCategory']->getShortDescription()): ?>
            <div class="categoryTopDescription" id="catDesc"><?php echo $this->_tpl_vars['actCategory']->getShortDescription(); ?>
</div>
        <?php endif; ?>
