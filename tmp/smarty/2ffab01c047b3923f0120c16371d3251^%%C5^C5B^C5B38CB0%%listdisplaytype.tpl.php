...
<?php if ($this->_tpl_vars['oView']->canSelectDisplayType()): ?>
    ...
    <div class="dropDown js-fnLink" id="viewOptions">
        <p>
            <label><?php echo smarty_function_oxmultilang(array('ident' => 'LIST_DISPLAY_TYPE','suffix' => 'COLON'), $this);?>
</label>
            <span><?php echo smarty_function_oxmultilang(array('ident' => $this->_tpl_vars['listType']), $this);?>
</span>
        </p>
        <ul class="drop FXgradGreyLight shadow">
            <li><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['oView']->getBaseLink())) ? $this->_run_mod_handler('oxaddparams', true, $_tmp, "ldtype=infogrid&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams'])) : smarty_modifier_oxaddparams($_tmp, "ldtype=infogrid&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams']))); ?>
" <?php if ($this->_tpl_vars['listType'] == 'infogrid'): ?>class="selected" <?php endif; ?>><?php echo smarty_function_oxmultilang(array('ident' => 'infogrid'), $this);?>
            ...
            <li><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['oView']->getBaseLink())) ? $this->_run_mod_handler('oxaddparams', true, $_tmp, "ldtype=grid&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams'])) : smarty_modifier_oxaddparams($_tmp, "ldtype=grid&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams']))); ?>
" <?php if ($this->_tpl_vars['listType'] == 'grid'): ?>class="selected" <?php endif; ?>><?php echo smarty_function_oxmultilang(array('ident' => 'grid'), $this);?>
</a></li>
            <li><a href="<?php echo ((is_array($_tmp=$this->_tpl_vars['oView']->getBaseLink())) ? $this->_run_mod_handler('oxaddparams', true, $_tmp, "ldtype=line&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams'])) : smarty_modifier_oxaddparams($_tmp, "ldtype=line&amp;_artperpage=".($this->_tpl_vars['_artPerPage'])."&amp;pgNr=0&amp;".($this->_tpl_vars['_additionalParams']))); ?>
