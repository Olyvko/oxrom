...
" class="viewAllHover">
                    <span><?php echo smarty_function_oxmultilang(array('ident' => 'VIEW_ALL_PRODUCTS'), $this);?>
</span>
                </a>
...
<?php if ($this->_tpl_vars['slideCount'] > 6): ?>
    ...
    <div class="itemSlider">
        <div class="leftHolder">            
            <div class="titleBlock slideNav"><strong><?php echo smarty_function_oxmultilang(array('ident' => 'OUR_BRANDS'), $this);?>
</strong></div>
