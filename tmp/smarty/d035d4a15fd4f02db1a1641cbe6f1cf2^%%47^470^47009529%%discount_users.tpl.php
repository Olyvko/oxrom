<?php /* Smarty version 2.6.28, created on 2016-03-16 21:54:17
         compiled from discount_users.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'discount_users.tpl', 1, false),array('function', 'oxmultilang', 'discount_users.tpl', 26, false),)), $this); ?>
...
" class="edittext" onclick="JavaScript:showDialog('&cl=discount_users&aoc=1&oxid=<?php echo $this->_tpl_vars['oxid']; ?>
');">
    </td>
    <td valign="top" class="edittext" align="left">
        <input <?php echo $this->_tpl_vars['readonly']; ?>
 type="button" value="<?php echo smarty_function_oxmultilang(array('ident' => 'GENERAL_ASSIGNUSERS'), $this);?>
" class="edittext" onclick="JavaScript:showDialog('&cl=discount_users&aoc=2&oxid=<?php echo $this->_tpl_vars['oxid']; ?>
');">
    </td>
    </tr>
</table>
