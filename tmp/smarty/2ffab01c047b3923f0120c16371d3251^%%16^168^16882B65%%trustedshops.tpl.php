...
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxmultilang', 'page/checkout/inc/trustedshops.tpl', 4, false),array('function', 'oxprice', 'page/checkout/inc/trustedshops.tpl', 18, false),array('block', 'oxifcontent', 'page/checkout/inc/trustedshops.tpl', 36, false),)), $this); ?>
...
?>
                  <?php $this->assign('oTsProductPrice', $this->_tpl_vars['oTsProduct']->getPrice()); ?>
...
" <?php if ($this->_tpl_vars['oView']->getCheckedTsProductId() == $this->_tpl_vars['oTsProduct']->getTsId()): ?>SELECTED<?php endif; ?>><?php echo smarty_function_oxmultilang(array('ident' => 'TRUSTED_SHOP_PROTECTION_FROM'), $this);?>
 <?php echo smarty_function_oxprice(array('price' => $this->_tpl_vars['oTsProduct']->getAmount(),'currency' => $this->_tpl_vars['currency']), $this);?>
 (<?php echo smarty_function_oxprice(array('price' => $this->_tpl_vars['oTsProductPrice']->getNettoPrice(),'currency' => $this->_tpl_vars['currency']), $this);?>
 <?php echo smarty_function_oxmultilang(array('ident' => 'PLUS_VAT'), $this);?>
 <?php echo smarty_function_oxprice(array('price' => $this->_tpl_vars['oTsProductPrice']->getVatValue(),'currency' => $this->_tpl_vars['currency']), $this);?>
 ) </option>
                  <?php else: ?>
                      <option value="<?php echo $this->_tpl_vars['oTsProduct']->getTsId(); ?>
" <?php if ($this->_tpl_vars['oView']->getCheckedTsProductId() == $this->_tpl_vars['oTsProduct']->getTsId()): ?>SELECTED<?php endif; ?>><?php echo smarty_function_oxmultilang(array('ident' => 'TRUSTED_SHOP_PROTECTION_FROM'), $this);?>
 <?php echo smarty_function_oxprice(array('price' => $this->_tpl_vars['oTsProduct']->getAmount(),'currency' => $this->_tpl_vars['currency']), $this);?>
 (<?php echo smarty_function_oxprice(array('price' => $this->_tpl_vars['oTsProductPrice']->getBruttoPrice(),'currency' => $this->_tpl_vars['currency']), $this);?>
