...
smarty_core_load_plugins(array('plugins' => array(array('block', 'oxifcontent', 'layout/page.tpl', 33, false),array('function', 'oxmultilang', 'layout/page.tpl', 40, false),array('insert', 'oxid_tracker', 'layout/page.tpl', 49, false),)), $this); ?>
<?php ob_start(); ?>
 ...
 ?>
    <?php if ($this->_tpl_vars['oView']->isPriceCalculated()): ?>
        ...
        <?php $this->_tag_stack[] = array('oxifcontent', array('ident' => 'oxdeliveryinfo','object' => 'oCont')); $_block_repeat=true;smarty_block_oxifcontent($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
            <?php $this->assign('tsBadge', ""); ?>
            <?php if ($this->_tpl_vars['oView']->getTrustedShopId()): ?>
                <?php $this->assign('tsBadge', 'TsBadge'); ?>
            <?php endif; ?>
            <div id="incVatMessage<?php echo $this->_tpl_vars['tsBadge']; ?>
">
...
" rel="nofollow"><?php echo smarty_function_oxmultilang(array('ident' => 'PLUS_SHIPPING2'), $this);?>
    ...
    <?php endif; ?>
    <?php if ($this->_tpl_vars['oView']->getClassName() != 'details'): ?>
