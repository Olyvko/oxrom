...
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/product/boxproducts.tpl", 'smarty_include_vars' => array('_boxId' => 'cross','_oBoxProducts' => $this->_tpl_vars['oView']->getCrossSelling(),'_sHeaderIdent' => 'HAVE_YOU_SEEN','_sHeaderCssClass' => 'lightHead')));
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <?php if (((is_array($_tmp=$this->_tpl_vars['oView']->getSimilarProducts())) ? $this->_run_mod_handler('count', true, $_tmp) : count($_tmp))): ?>
        <?php ob_start(); ?>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/product/boxproducts.tpl", 'smarty_include_vars' => array('_boxId' => 'similar','_oBoxProducts' => $this->_tpl_vars['oView']->getSimilarProducts(),'_sHeaderIdent' => 'SIMILAR_PRODUCTS','_sHeaderCssClass' => 'lightHead')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->append('oxidBlock_productbar', ob_get_contents());ob_end_clean(); ?>
    ...
    <?php if (((is_array($_tmp=$this->_tpl_vars['oView']->getAccessoires())) ? $this->_run_mod_handler('count', true, $_tmp) : count($_tmp))): ?>
        <?php ob_start(); ?>
            <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "widget/product/boxproducts.tpl", 'smarty_include_vars' => array('_boxId' => 'accessories','_oBoxProducts' => $this->_tpl_vars['oView']->getAccessoires(),'_sHeaderIdent' => 'ACCESSORIES','_sHeaderCssClass' => 'lightHead')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
        <?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->append('oxidBlock_productbar', ob_get_contents());ob_end_clean(); ?>
