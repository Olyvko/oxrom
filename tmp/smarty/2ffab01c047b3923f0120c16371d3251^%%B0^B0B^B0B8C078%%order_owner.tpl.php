<?php /* Smarty version 2.6.28, created on 2016-05-14 19:01:08
         compiled from /var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'oxcontent', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 14, false),array('function', 'oxmultilang', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 19, false),array('function', 'oxprice', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 76, false),array('modifier', 'strip_tags', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 50, false),array('modifier', 'oxescape', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 637, false),array('modifier', 'oxmultilangsal', '/var/www/oxid/application/views/azure/tpl/email/html/order_owner.tpl', 681, false),)), $this); ?>
            ...
            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                <tr>
                    <td height="15" width="100" style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;"><b><?php echo smarty_function_oxmultilang(array('ident' => 'PRODUCT'), $this);?>
</b></p>
                    </td>
                    ...
                    <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;"><b><?php echo smarty_function_oxmultilang(array('ident' => 'UNIT_PRICE'), $this);?>
</b></p>
                    </td>
                    <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;"><b><?php echo smarty_function_oxmultilang(array('ident' => 'QUANTITY'), $this);?>
</b></p>
                    </td>
                    <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;"><b><?php echo smarty_function_oxmultilang(array('ident' => 'VAT'), $this);?>
</b></p>
                    </td>
                    <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                        <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0; padding: 0;"><b><?php echo smarty_function_oxmultilang(array('ident' => 'TOTAL'), $this);?>
</b></p>
                    </td>
                </tr>
...
<?php endif; ?></b>
                                    ...
                                    <em style="font-size: 7pt;font-weight: normal;"><?php echo smarty_function_oxmultilang(array('ident' => 'DISCOUNT','suffix' => 'COLON'), $this);?>
                        ...
                        <tr valign="top">
                            <td style="padding: 5px; border-bottom: 4px solid #ddd;">
                                <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; margin: 0;">
                                    <b><?php echo smarty_function_oxmultilang(array('ident' => 'ATENTION_GREETING_CARD','suffix' => 'COLON'), $this);?>
</b><br>
...
<?php endif; ?> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_METHOD','suffix' => 'COLON'), $this);?>
                ...
                <?php if ($this->_tpl_vars['payment']->oxuserpayments__oxpaymentsid->value != 'oxempty'): ?>
                    <h3 style="font-weight: bold; margin: 20px 0 7px; padding: 0; line-height: 35px; font-size: 12px;font-family: Arial, Helvetica, sans-serif; text-transform: uppercase; border-bottom: 4px solid #ddd;">
                        <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_INFORMATION','suffix' => 'COLON'), $this);?>

                    </h3>
                    <p style="font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                        <b><?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_METHOD','suffix' => 'COLON'), $this);?>
