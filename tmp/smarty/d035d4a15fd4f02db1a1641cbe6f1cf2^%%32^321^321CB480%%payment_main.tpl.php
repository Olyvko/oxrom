...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'payment_main.tpl', 2, false),array('function', 'oxmultilang', 'payment_main.tpl', 35, false),array('function', 'oxinputhelp', 'payment_main.tpl', 39, false),array('block', 'oxhasrights', 'payment_main.tpl', 185, false),)), $this); ?>
...
" <?php if ($this->_tpl_vars['sum'] == $this->_tpl_vars['edit']->oxpayments__oxaddsumtype->value): ?>SELECTED<?php endif; ?>><?php echo $this->_tpl_vars['sum']; ?>
            ...
            <tr>
                ...
                <td class="edittext">
                  <table cellspacing="0" cellpadding="0" border="0">
                    <tr>
                        <td><input type="checkbox" name="oxpayments__oxaddsumrules[]" value="1" <?php if (! $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value || $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value & 1): ?>checked<?php endif; ?>> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_MAIN_ADDSUMRULES_ALLGOODS'), $this);?>
</td>
                        <td rowspan="5" valign="top"><?php echo smarty_function_oxinputhelp(array('ident' => 'HELP_PAYMENT_MAIN_ADDSUMRULES'), $this);?>
</td>
                    </tr>
                    <tr><td><input type="checkbox" name="oxpayments__oxaddsumrules[]" value="2" <?php if (! $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value || $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value & 2): ?>checked<?php endif; ?>> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_MAIN_ADDSUMRULES_DISCOUNTS'), $this);?>
</td></tr>
                    <tr><td><input type="checkbox" name="oxpayments__oxaddsumrules[]" value="4" <?php if (! $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value || $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value & 4): ?>checked<?php endif; ?>> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_MAIN_ADDSUMRULES_VOUCHERS'), $this);?>
</td></tr>
                    <tr><td><input type="checkbox" name="oxpayments__oxaddsumrules[]" value="8" <?php if (! $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value || $this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value & 8): ?>checked<?php endif; ?>> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_MAIN_ADDSUMRULES_SHIPCOSTS'), $this);?>
</td></tr>
                    <tr><td><input type="checkbox" name="oxpayments__oxaddsumrules[]" value="16" <?php if ($this->_tpl_vars['edit']->oxpayments__oxaddsumrules->value & 16): ?>checked<?php endif; ?>> <?php echo smarty_function_oxmultilang(array('ident' => 'PAYMENT_MAIN_ADDSUMRULES_GIFTS'), $this);?>
</td></tr>
                  </table>
                </td>
            </tr>
