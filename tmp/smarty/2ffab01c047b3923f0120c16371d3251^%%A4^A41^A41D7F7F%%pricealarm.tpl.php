...
"/>
    ...
    <ul class="form">
        <li>
            <label><?php echo smarty_function_oxmultilang(array('ident' => 'YOUR_PRICE'), $this);?>
...
<?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_oxhasrights($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>" size="20" maxlength="32">
        ...
        <li>
            <label><?php echo smarty_function_oxmultilang(array('ident' => 'EMAIL','suffix' => 'COLON'), $this);?>
</label>
...
<?php endif; ?>" size="20" maxlength="128">
        ...
        <li>
            <label><?php echo smarty_function_oxmultilang(array('ident' => 'VERIFICATION_CODE','suffix' => 'COLON'), $this);?>
</label>
...
">
        ...
        <li class="formSubmit">
            <button class="submitButton largeButton" type="submit"><?php echo smarty_function_oxmultilang(array('ident' => 'SEND'), $this);?>
</button>
        </li>
    </ul>
</form>