<?php /* Smarty version 2.6.28, created on 2016-05-12 19:40:39
         compiled from voucherserie_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'oxmultilangassign', 'voucherserie_list.tpl', 1, false),array('modifier', 'oxaddslashes', 'voucherserie_list.tpl', 126, false),array('function', 'oxmultilang', 'voucherserie_list.tpl', 66, false),)), $this); ?>
...
<tr>
    	...
    	<td class="listheader first" height="15" width="30" align="center"><a href="javascript:void(0)" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'GENERAL_ACTIVTITLE'), $this);?>
</a></td>
        <td class="listheader" height="15">&nbsp;<a href="Javascript:top.oxid.admin.setSorting( document.search, 'oxvoucherseries', 'oxserienr', 'asc');document.search.submit();" class="listheader"><?php echo smarty_function_oxmultilang(array('ident' => 'VOUCHERSERIE_LIST_SERIALNUM'), $this);?>
</a></td>
...
<?php if ($this->_tpl_vars['listitem']->getVoucherStatusByDatetime() == 1): ?> active<?php endif; ?>" height="15"><div class="listitemfloating">&nbsp</a></div></td>
        <td valign="top" class="<?php echo $this->_tpl_vars['listclass']; ?>
...
<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "pagenavisnippet.tpl", 'smarty_include_vars' => array('colspan' => '7')));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
</table>
