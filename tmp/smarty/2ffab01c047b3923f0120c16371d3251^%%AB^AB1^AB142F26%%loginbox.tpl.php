...
">
            ...
            <div class="loginForm corners">
                ...
                <p>
                    ...
                    <input id="loginPasword" type="password" name="lgn_pwd" class="textbox passwordbox" value=""><strong><a class="forgotPasswordOpener" href="#" title="<?php echo smarty_function_oxmultilang(array('ident' => 'FORGOT_PASSWORD'), $this);?>
">?</a></strong>
                </p>
            ...
            <?php if ($this->_tpl_vars['oViewConf']->getShowFbConnect()): ?>
                <div class="altLoginBox corners clear">
                    <span><?php echo smarty_function_oxmultilang(array('ident' => 'LOGIN_WITH','suffix' => 'COLON'), $this);?>
</span>
