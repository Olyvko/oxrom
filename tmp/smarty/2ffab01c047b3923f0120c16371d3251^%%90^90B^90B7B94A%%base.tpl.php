<?php /* Smarty version 2.6.28, created on 2016-03-13 19:33:10
         compiled from layout/base.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'strip_tags', 'layout/base.tpl', 31, false),array('function', 'oxstyle', 'layout/base.tpl', 56, false),array('function', 'oxscript', 'layout/base.tpl', 96, false),array('function', 'oxid_include_dynamic', 'layout/base.tpl', 110, false),)), $this); ?>
<?php ob_start(); ?>
    <meta http-equiv="Content-Type" content="text/html; charset=<?php echo $this->_tpl_vars['oView']->getCharSet(); ?>
">
    <title><?php echo $this->_tpl_vars['oView']->getPageTitle(); ?>
</title>
...
<!DOCTYPE HTML>
<?php $this->assign('sLanguage', $this->_tpl_vars['oView']->getActiveLangAbbr()); ?>
<html <?php if ($this->_tpl_vars['sLanguage']): ?>lang="<?php echo $this->_tpl_vars['sLanguage']; ?>
"<?php endif; ?> <?php if ($this->_tpl_vars['oViewConf']->getShowFbConnect()): ?>xmlns:fb="http://www.facebook.com/2008/fbml"<?php endif; ?>>
    <head>
